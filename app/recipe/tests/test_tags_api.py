...
class PrivateTagsApiTests(TestCase):
    ...
    def test_tags_limited_to_user(self):
        ...
        tag = Tag.objects.create(user=self.user, name="User1")
    ...
    def test_update_tag(self):
        """Test updating a tag."""
        tag = Tag.objects.create(user=self.user, name="ExampleTag")
    ...
    def test_delete_tag(self):
        """Test deleting a tag."""
        tag = Tag.objects.create(user=self.user, name="DeleteMe")
